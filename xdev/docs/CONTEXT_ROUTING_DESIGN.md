...
> **问题来源**：TqQuant 项目查询案例——艾克斯因全局 history 上下文污染，将 Python 量化交易项目误答为 TypeScript AI 项目。  
...
LLM 的注意力机制对"高频出现词汇"有强烈偏向。当 history 中有 600 条 xdev 相关内容时，即便有工具说明，主 LLM 的推理起点已经偏移了。
...
| 场景 | 改造前 | 改造后 |
|------|-------|--------|
| 查询 TqQuant 项目 | 受 xdev 历史污染，答错 | Stage 1 路由到独立 T3 bucket，干净执行 |
...
一条飞书消息可能包含多个独立话题，例如：
> "帮我看看 TqQuant 的 README，顺便把 xdev 的日志级别改成 debug"
