...
export { mapTool, createMapTool } from './map-tool'
...
// Workflow 工具
export { createWorkflowTool, workflowTool } from './workflow-tool'
export {
  WorkflowRuntime,
  getWorkflowRuntime,
...
export function createDefaultToolRegistry(): ToolRegistry {
  ...
  registry.register(createMapTool())
